    ...
    return (
        <section className="custom-container d-flex flex-column text-center">
            <div className="container mb-3">
                ...
                <div>
                    <p className="fs-5 fs-sm-6 fs-md-7 fs-lg-8 lh-lg mb-3" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p className="fs-5 fs-sm-6 fs-md-7 fs-lg-8 lh-lg mb-3" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <p className="fs-5 fs-sm-6 fs-md-7 fs-lg-8 lh-lg mb-3" data-aos="fade-up" data-aos-delay="600">
